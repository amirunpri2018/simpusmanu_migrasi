            ...
            <div class="box box-primary">
                ...
                <div class="box-body table-responsive">
                    <table id="mytable" class="table table-bordered table-striped" cellspacing="0" width="100%">
                        ...
                        function chek($id) {
                            $CI = get_instance();
                            $result = $CI->db->get_where('tb_menu', array('parent' => 0, 'child' => $id))->row_array();
                        ...
                        foreach ($record as $r) {
                            ...
                            echo"
                               ...
                               <td>" . $katmenu . "</td>
                                   ";
                            ?>                             
                            <td><?php echo ($r->allow) ? anchor("menu/deny/" . $r->id_menu, 'Allow') : anchor("user/allow/" . $r->id_user, 'Deny'); ?></td>
                            <?php
                            echo"
