                ...
                <div class="box-body box-profile">
                    ...
                    <ul class="list-group list-group-unbordered">
                        <li class="list-group-item">
                            <b>NIK</b> <a class="pull-right"><?php echo $pegawai['nip'] ?></a>
                        </li>
                        <li class="list-group-item">
                        ...
                        <li class="list-group-item">
                            <b>Gender</b> <a class="pull-right"><?php echo $pegawai['jenis_kelamin'] ?></a>
                        </li>
                        <li class="list-group-item">
                    ...
                    <a href="<?php echo base_url('simpeg_data_pegawai/update/' . $pegawai['id_pegawai']); ?>" class="btn btn-primary btn-block"><b>Edit</b></a>
                </div>
                <!-- /.box-body -->
            </div>
            <!-- /.box -->
        ...
        <div class="col-md-9">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#pegawai" data-toggle="tab" aria-expanded="true">Data Pegawai</a></li>
                    ...
                    <li class=""><a href="#jabatan" data-toggle="tab" aria-expanded="false">Riwat Jabatan</a></li>
                ...
                <div class="tab-content">
                                ...
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="width:65%"><?php echo strtoupper($pegawai['nama_pegawai'].', '.$pegawai['gelar_belakang']) ?></td>
                                        </tr>
                                        <tr>
                    ...
                    <div class="tab-pane" id="pendidikan">
                        ...
                        <strong><i class="fa fa-book margin-r-5"></i> RIWAYAT PENDIDIKAN [ <a><?php echo anchor('simpeg_data_pegawai/addpendidikan/' . $pegawai['id_pegawai'], 'Add New') ?></a> ]</strong>                            
                        <br><br>
                        <table class="table ">
                            <tbody>
                                <tr>
                                ...
                                foreach ($pendidikan as $row) {
                                    echo"
                                        <tr>                                     
                                            ...
                                            <td>" . anchor('simpeg_data_pegawai/editpendidikan/' . $row->id_pendidikan, '<i class="btn btn-sm glyphicon glyphicon-edit" data-toggle="tooltip" title="Edit"></i>') . "</td>
                                        </tr> ";
                                }
                                ?>                           
                            </tbody>
                    ...
                    <div class="tab-pane" id="pelatihan">
                        <strong><i class="fa fa-book margin-r-5"></i>PELATIHAN & SEMINAR [ <a><?php echo anchor('simpeg_data_pegawai/addpelatihan/' . $pegawai['id_pegawai'], 'Add New') ?></a> ]</strong>                            
                        <br><br>
                        <table class="table ">
                            <tbody>
                                <tr>
                                ...
                                foreach ($pelatihan as $row) {
                                    echo"
                                        <tr>                                     
                                            ...
                                            <td>" . $row->catatan . "</td>
                                            <td>" . anchor('simpeg_data_pegawai/editpelatihan/' . $row->id_data_pelatihan, '<i class="btn btn-sm glyphicon glyphicon-edit" data-toggle="tooltip" title="Edit"></i>') . "</td>
                                        </tr> ";
                                }
                                ?>                           
                            </tbody>
                    ...
                    <div class="tab-pane" id="penghargaan">
                        <strong><i class="fa fa-book margin-r-5"></i>PENGHARGAAN [ <a><?php echo anchor('simpeg_data_pegawai/addpenghargaan/' . $pegawai['id_pegawai'], 'Add New') ?></a> ]</strong>                            
                        <br><br>
                        <table class="table ">
                            <tbody>
                                <tr>
                                ...
                                foreach ($penghargaan as $row) {
                                    echo"
                                        <tr>                                     
                                            ...
                                            <td>" . anchor('simpeg_data_pegawai/editpenghargaan/' . $row->id_penghargaan, '<i class="btn btn-sm glyphicon glyphicon-edit" data-toggle="tooltip" title="Edit"></i>') . "</td>
                                        </tr> ";
                                }
                                ?>                           
                            </tbody>
                    ...
                    <div class="tab-pane" id="jabatan">
                        <strong><i class="fa fa-book margin-r-5"></i>RIWAYAT JABATAN [ <a><?php echo anchor('simpeg_data_pegawai/addjabatan/' . $pegawai['id_pegawai'], 'Add New') ?></a> ]</strong>                            
                        <br><br>
                        <table class="table ">
                            <tbody>
                                <tr>
                                ...
                                foreach ($riwayatjab as $row) {
                                    echo"
                                        <tr>                                     
                                            ...
                                            <td>" . $row->uraian . "</td>
                                            <td>" . anchor('simpeg_data_pegawai/editjabatan/' . $row->id_riwayat_jabatan, '<i class="btn btn-sm glyphicon glyphicon-edit" data-toggle="tooltip" title="Edit"></i>') . "</td>
                                        </tr> ";
                                }
                                ?>                           
                            </tbody>
                    ...
                    <div class="tab-pane" id="keluarga">
                        <strong><i class="fa fa-users margin-r-5"></i> DATA KELUARGA [ <a><?php echo anchor('simpeg_data_pegawai/addkeluarga/' . $pegawai['id_pegawai'], 'Add New') ?></a> ]</strong>                            
                        <br><br>
                        <table class="table ">
                            <tbody>
                                <tr>
                                ...
                                foreach ($keluarga as $row) {
                                    echo"
                                                <tr>                                     
                                                  ...
                                                  <td>" . $row->pekerjaan . "</td>                                                   
                                                  <td>" . anchor('simpeg_data_pegawai/editkeluarga/' . $row->id_keluarga, '<i class="btn btn-sm glyphicon glyphicon-edit" data-toggle="tooltip" title="Edit"></i>') . "</td>
                                                </tr> ";
                                }
                                ?>                           
                            </tbody>
                    ...
                    <div class="tab-pane" id="penilaian">
                        <strong><i class="fa fa-users margin-r-5"></i>PENILAIAN/CATATAN [ <a><?php echo anchor('simpeg_data_pegawai/addpenilaian/' . $pegawai['id_pegawai'], 'Add New') ?></a> ]</strong>                            
                        <br><br>
                        <table class="table ">
                            <tbody>
                                <tr>                                    
                                ...
                                foreach ($penilaian as $row) {
                                    echo"
                                                <tr>                                     
                                                  <td>" . tgl_indo($row->tanggal). "</td>                                                                                    
                                                  <td>" . $row->catatan . "</td>                                                   
                                                  <td>" . anchor('simpeg_data_pegawai/editpenilaian/' . $row->id_penilaian, '<i class="btn btn-sm glyphicon glyphicon-edit" data-toggle="tooltip" title="Edit"></i>') . "</td>
                                                </tr> ";
                                }
                                ?>                           
                            </tbody>
