    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="col-md-5">
                <?php
                    echo form_open('group/menu_edit_action');
                ?>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="hidden"  name="nama_old" value="<?php echo $record['nama_menu'] ?>" >
                        ...
                        <div class="form-group">
                                ...
                                <select name="kat_menu" class="form-control">
                                    ...
                                    foreach ($katmenu as $k) {
                                        echo "<option value='$k->child'";
                                        echo $record['parent'] == $k->child ? 'selected' : '';
