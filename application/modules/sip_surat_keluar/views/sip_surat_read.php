...
<section class="invoice">
    ...
    <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
            ...
            if (empty($lampiran)){
                ...
                echo "1. ", anchor_popup('upload/surat_keluar/' . $lampiran, $lampiran); 
            }            
            ?>
            <br>
            <br>
    ...
    <!--
     <div class="row no-print">
         <div class="col-xs-12">
             <a href="<?php echo base_url('sip_surat_keluar/cetak/' . $id_surat); ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
