...
<script>
    ...
    function ajaxLoad(){
        ...
        $('#mytable').dataTable({
            ...
            "ajax": {
                "url": "<?php echo base_url('sip_surat_keluar/view_data'); ?>",
                "type": "GET",
                "data": {                   
                    'tahun': tahun,
                    'kode': kode
        ...
        <div class='col-xs-12'>
            <div class='box box-primary'>  
                <div class='box-header with-border'>
                    <div class="col-lg-2">
                        <h3 class='box-title'><?php echo anchor('sip_surat_keluar/create/', '<i class="glyphicon glyphicon-plus"></i>Tambah Data', array('class' => 'btn btn-primary btn-sm')); ?>
                        </h3>
                    </div>
                    <div class="col-lg-7">   
                        <table>
