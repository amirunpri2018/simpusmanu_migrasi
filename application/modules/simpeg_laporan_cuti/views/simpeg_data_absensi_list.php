        ...
        <div class='col-xs-12'>
            <div class='box box-primary'>  
                <div class='box-header with-border'>
                    <div class="col-md-6">
                        <h3 class='box-title'>
                            <?php echo anchor(site_url('simpeg_laporan_cuti/excel'), ' <i class="fa fa-file-excel-o"></i> Excel', 'class="btn btn-primary btn-sm"'); ?>
                        </h3>
                    </div>                    
                    <div class="col-md-6 ">
                        <?php echo form_open('simpeg_laporan_cuti'); ?>
                        <div class="col-sm-5">
