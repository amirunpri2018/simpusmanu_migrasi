        ...
        <div class='col-md-12'>
            ...
            <div class='box box-primary'>
                <div class='box-header'>
                    <div class='col-md-5'>
                        <?php
                        echo form_open('simpeg_data_dosen/create_action');
                        ?> 
                        <div class='box-body'>
                            ...
                            <div class='form-group'>
                                <label>NIDN</label> <?php echo form_error('nidn') ?>
                                <input type="text" class="form-control" name="nidn" id="nip" placeholder="NIDN" value="<?php echo $nidn; ?>" />
                            </div> 
                            <div class='form-group'>
                                <label>Nama Lengkap</label>  <?php echo form_error('nama_pegawai') ?>
                                <input type="text" class="form-control" name="nama_pegawai" id="nama_pegawai" placeholder="Nama Lengkap" value="<?php echo $nama_pegawai; ?>" />
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    <label>Gelar Depan</label>
                                    <input type="text" class="form-control" name="gelar_depan" id="nip" placeholder="Gelar Depan" value="<?php echo $gelar_depan; ?>" />

                                </div>                               
                                <div class="form-group col-lg-6">
                                    <label>Gelar Belakang</label>
                                    <input type="text" class="form-control" name="gelar_belakang" id="nip" placeholder="Gelar Belakang" value="<?php echo $gelar_belakang; ?>" />
                        ...
                        <div class='box-footer'>                            
                            ...
                            <a href="<?php echo site_url('simpeg_data_dosen') ?>" class="btn btn-default">Cancel</a>
                        </div>
                        </form>
                    </div><!-- /.box-body -->
                </div><!-- /.box -->
