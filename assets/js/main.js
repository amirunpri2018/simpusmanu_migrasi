$(function(){
    ...
    var base_url='http://localhost/SIMAKBID/'; // Here i define the base_url
    ...
    $('#calendar').fullCalendar({
        ...
        events: base_url+'vss_calendar/getEvents',
        ...
        dayClick: function(date, event, view) {
         ...
         eventDrop: function(event, delta, revertFunc) {  
               ...
               $.post(base_url+'vss_calendar/dragUpdateEvent',{                            
                id:event.id,
    ...
    $('.modal').on('click', '#add-event',  function(e){
        if(validator(['title', 'description'])) {
            $.post(base_url+'vss_calendar/addEvent', {
                title: $('#title').val(),
    ...
    $('.modal').on('click', '#update-event',  function(e){
        if(validator(['title', 'description'])) {
            $.post(base_url+'vss_calendar/updateEvent', {
                id: currentEvent._id,
                title: $('#title').val(),
                description: $('#description').val(),
                color: $('#color').val(),
    ...
    $('.modal').on('click', '#delete-event',  function(e){
        $.get(base_url+'vss_calendar/deleteEvent?id=' + currentEvent._id, function(result){
            $('.modal').modal('hide');
            $('#calendar').fullCalendar("refetchEvents");
        });
    });
